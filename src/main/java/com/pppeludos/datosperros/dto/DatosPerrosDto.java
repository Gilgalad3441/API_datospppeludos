package com.pppeludos.datosperros.dto;

public class DatosPerrosDto {
    ...
    public DatosPerrosDto() {
    }
    
    public DatosPerrosDto(int idDatosPerros, String foto, String nombre_perro, String donde_esta, int numero_chip, String fecha_nacimiento, String licencia, String raza, String castrado, String ultima_desparasitacion, String vacuna_rabia, String leishmaniasis, String pendiente_operacion, String enfermedades, String tratamiento) {
    	this.setIdDatosPerros(idDatosPerros);
    	this.foto = foto;
